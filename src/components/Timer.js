...
const Timer = () => {
  ...
  return (
    <div style={{ ...styles.container, backgroundColor: isDarkMode ? "#222" : "#f956" }}>
      <h1 style={{ ...styles.timer, color: isDarkMode ? "white" : "black" }}>{formatTime(time)}</h1>
      <div style={styles.buttonContainer}>
        <button
          style={{ ...styles.button, backgroundColor: isDarkMode ? "#2324" : "#a2324" }}
        ...
        {time > 0 && (
          <button
            style={{ ...styles.button, backgroundColor: "#DC45" }}
            onClick={() => setTime(0)}
          >
            Сброс
          </button>
